    ...
    methods: {
        updateElement() {
            if (this.formData.isSequential) {
                ...
                multiInstanceLoopCharacteristics.$attrs['camunda:collection'] = this.formData.collection
                multiInstanceLoopCharacteristics.$attrs['camunda:elementVariable'] = this.formData.elementVariable
