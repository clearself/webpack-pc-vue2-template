    ...
    <div class="list">
        ...
        <div class="list-container">
            <div class="ub ub-pj w100 mb-1 ub-ac">
                <div class="list-tips">自动剧本配置</div>
                <div class="ub">
            ...
            <el-table
                ...
                <el-table-column prop="configName" label="剧本名称" width="300">
                </el-table-column>
                ...
                <el-table-column prop="workOrder" label="剧本模板" width="200">
                    <template slot-scope="{row}">
                        <p>{{workTemplateName(row.scriptOrder)}}</p>
                    </template>
                </el-table-column>
                <el-table-column prop="ruleScope" label="剧本范围">
                    <template slot-scope="{row}">
        ...
        <!--增加内容开始-->
        <el-dialog title="添加自动剧本配置" :visible.sync="addDialog" width="700px" custom-class="common-dialog">
            <el-form :model="addForm" :rules="rules" ref="addForm" label-position="top">
                <el-form-item label="剧本名称：" prop="name" :label-width="formLabelWidth">
                    <el-input size="small" v-model.trim="addForm.name" placeholder="请输入" autocomplete="off" clearable></el-input>
                </el-form-item>
                <el-form-item label="剧本模板：" prop="template" :label-width="formLabelWidth">
                    <el-select
                ...
                <el-form-item label="剧本范围：" prop="rules" :label-width="formLabelWidth">
        ...
        <!--编辑内容开始-->
        <el-dialog title="编辑自动剧本配置" :visible.sync="editDialog" width="700px" custom-class="common-dialog">
...
} from '../../server/alarm/auto_script_config.js'
import {
    getConfigCondition,
    getAlarmFields
...
export default {
    ...
    methods: {
            ...
            get_auto_work_list(data).then(res => {
                ...
                if (list.length > 0) {
                    list.forEach(item => {
                        ...
                        obj.scriptOrder = item.scriptOrder
        ...
        addWork() {
            let data = {
                ...
                paramsData: {
                    ...
                    startType: 1,
                    scriptOrder: this.addForm.template,
        ...
        editWork() {
            let data = {
                ...
                paramsData: {
                    ...
                    scriptOrder: this.editForm.template,
        ...
        handleEdit(row) {
            ...
            this.editForm.template = row.scriptOrder
