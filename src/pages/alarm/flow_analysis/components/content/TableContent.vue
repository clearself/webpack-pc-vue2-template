        ...
        <div class="ub ub-f1 ub-ver expert-right" style="overflow-x: hidden;">
            <div class="ub ub-pj w100 mb-1">
                ...
                <div style="flex: 1;text-align: right;">
                    ...
                    <el-button v-per="['data_log_highlight']" style="margin-left: 10px;border-radius: 4px;background: #b500ff;border-color: rgb(181, 0, 255)" size="small" icon="iconfont icon-shezhi" type="primary" @click="$parent.highlightDialog = true">配置高亮词</el-button>
                                                ...
                                                <div style="max-width: 70%;text-align: justify;word-break: break-all;">
                                                    <el-popover popper-class="add-search" placement="bottom" title="" trigger="click">
                                                        ...
                                                        <span
                                                            class="highlighted-inner"
                                                            slot="reference"
                                                            style="font-size: 12px; text-decoration: unset; color: #191919;cursor: default;"
                                                        >
                                                            {{ item.value }}
                                                        </span>
                                                    </el-popover>
...
export default {
    ...
    watch: {
        type: {
            handler(newVal) {
                if (newVal === 1) {
                    this.heigRight = 'calc(100vh - 420px)'
                    this.heigLeft = 'calc(100vh - 380px)'
                } else {
                    this.heigRight = 'calc(100vh - 330px)'
                    this.heigLeft = 'calc(100vh - 380px)'
                }
        ...
        viewChartOpen: {
            handler(newVal) {
                if (newVal) {
                    if (this.type == 1) {
                        this.heigRight = 'calc(100vh - 590px)'
                        this.heigLeft = 'calc(100vh - 530px)'
                    } else {
                        this.heigRight = 'calc(100vh - 505px)'
                        this.heigLeft = 'calc(100vh - 490px)'
                    }
                } else {
                    if (this.type == 1) {
                        this.heigRight = 'calc(100vh - 435px)'
                        this.heigLeft = 'calc(100vh - 380px)'
                    } else {
                        this.heigRight = 'calc(100vh - 355px)'
                        this.heigLeft = 'calc(100vh - 380px)'
                    }
                }
            },
...
.custom-star #app .expert-left {
    border: none !important;
    background-color: rgba(0,0,0,0) !important;
}
.custom-star #app .expert-right {
    border: none !important;
    background-color: rgba(0,0,0,0) !important;
}
.custom-star #app .left-title {
    color: #fff !important;
}

.custom-star #app .list-group-item1 {
    margin: 8px 0;
    color: #fff;
    // padding:0 10px;
    box-sizing: border-box;
