                ...
                <div
                    ...
                    <div class="chart-num-box" style="margin-top: 15px;width: 200px;">
                        <div class="ub ub-ac mb-3">
                            <p class="chaTex" style="font-size: 14px;">结果总量</p>
                        ...
                        <div class="mb-2 chaTex" style="font-size: 24px;color: #0052d9;">{{parseInt(logs_total)}}</div>
...
import ProgressBar from '@/pages/alarm/flow_analysis/components/chart/ProgressBar'
// import the component
import TableContent from '@/pages/alarm/flow_analysis/components/content/TableContent'
import Alarm from '@/pages/alarm/flow_analysis/components/alarm/index.vue'
import FilterCondition from '@/pages/alarm/flow_analysis/components/FilterCondition'
import CustomSearch from '@/pages/alarm/flow_analysis/components/custom_search/index'
import ConditionRules from '@/pages/alarm/flow_analysis/components/ConditionRules'
import TableChart from '@/pages/alarm/flow_analysis/components/chart/TableChart'
...
.custom-star #app .general ::v-deep .filter-title {
