<template>
    <div class="refresh" ref="selfRefresh">
        <el-select class="custom-select" size="small" v-model="refreshData" placeholder="请选择" @change="selectChange" @visible-change="visibleChange" popper-class="refresh-select" :style="{'width':refreshData==0||refreshData.length>=2 ?'85px':'130px'}">
            <el-option
        ...
        <div class="custom" v-if="customShow">
            ...
            <div style="color: rgba(0,0,0,.4);width: 159px;margin-bottom: 10px">说明：当单位选择秒时最少可选择30秒，当单位选择分钟时最多可选择60分钟，当单位选择小时时最多可选择24小时</div>
            <el-button style="margin-left:100px" size="mini" type="primary" @click.native="use">应用</el-button>
        </div>
    </div>
</template>
