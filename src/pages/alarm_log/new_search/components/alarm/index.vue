<template>
    <div>
        <el-drawer custom-class="drawer-dialog" title="发起事件" :visible.sync="alarmDialog" direction="rtl" :size="900" :show-close="true" :before-close="closeDialog" @close="closeDialog" :wrapperClosable="false">
                ...
                <div
                    ...
                    <div class="drawer-pad">
                        <el-form :model="addForm" :rules="rules" ref="addForm" :inline="true" label-position="top">
                            ...
                            <el-form-item label="">
                                <div class="w100">
                                    <div style="width:70px;text-align:left;color:#999;margin-right: 10px">
                                        事件描述:
                                    </div>
                        ...
                        <span slot="footer" class="dialog-footer">
                            ...
                            <Debounce :time='10000' :isDebounce="2">
                                <el-button size="small" type="primary" @click.native="handleQuery('addForm')">确 定</el-button>
                            </Debounce>
                        </span>
                    </div>
                </div>
...
<script>
import { getAlarmType, getAlarmWorkMould, saveAlarm, getLogInfo } from '@/server/alarm_log/api.js'
