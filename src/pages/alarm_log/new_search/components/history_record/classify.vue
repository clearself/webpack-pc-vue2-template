    ...
    <div>
        ...
        <el-dialog :append-to-body="true" :title="addForm.id?'编辑分组':'添加分组'" :visible.sync="addDialog" width="700px" custom-class="common-dialog">
            <div style="width:100%;margin: 0 auto;">
                <el-form label-width="80px" label-position="right" :rules="rules" ref="addForm" :model="addForm">
...
import { findSearchType, saveSearchType, deleteSearchType } from '@/server/alarm_log/api.js'
