<template>
    <div>
        ...
        <div class="event-content ub w100 mb-2" style="padding: 11px 10px;border-radius: 4px;">
        ...
        <div class="w100 search-box">
            <div class="ub w100 ub-pj mb-1 ub-ac">
                ...
                <div>
                    <el-button icon="iconfont icon-daochu"  size="small" type="primary" @click="handleExport" style="padding-top: 5px !important;">导出</el-button>
                    <el-button style="margin-right: 10px;color: #ffffff;background: #00a870;" icon="el-icon-sort" @click="changeAllState" size="small">状态变更</el-button>
                    <el-dropdown trigger="click" :hide-on-click="false" style="margin-right: 5px;">
                        <el-button icon="el-icon-edit-outline" size="small" style="color: #ffffff;background: #b500ff;">配置列</el-button>
                    ...
                    <el-button style="margin-left: 5px;" icon="el-icon-delete" size="small" type="danger" @click="judgeDelete">删除</el-button>
                </div>
            </div>
        </div>
        <div>
            <el-table
                ...
                <el-table-column label="操作" align="center" width="160" fixed="right" class-name="deepBg">
                    <template slot-scope="scope">
                        <div>
                            <el-button @click="handleSee(scope.row)" size="small" type="text">查看</el-button>
                            <el-button :disabled="scope.row.reportFrom==1" size="small" type="text" @click="changeOption(2,scope.row)">编辑</el-button>
                            <el-dropdown trigger="click" :hide-on-click="true" style="margin: 0 10px;">
                                ...
                                <el-dropdown-menu slot="dropdown" style="width: 90px;">
                                    <el-dropdown-item command="a">
                                        <el-button size="small" type="text" :disabled="scope.row.isStart==1" @click="changeOption(1,scope.row)">发起工单</el-button>
                                    </el-dropdown-item>
                                    <el-dropdown-item command="b">
                                        <el-button size="small" type="text" @click="changeOption(3,scope.row)">状态变更</el-button>
                                    </el-dropdown-item>
                                </el-dropdown-menu>
                            </el-dropdown>
                            <el-button :disabled="scope.row.isStart==1" size="small" type="text" @click="changeOption(4,scope.row)">删除</el-button>
                        </div>
                    </template>
                </el-table-column>
        ...
        <el-drawer :visible.sync="seeDialog" direction="rtl" :size="1200" :wrapperClosable="false" title="详情" :append-to-body="true" custom-class="custom-drawer">
        ...
        <!--状态变更内容开始-->
        <el-dialog v-dialogDrag title="事件状态变更" :visible.sync="stateDialog" width="700px" custom-class="common-dialog" :append-to-body="true">
        ...
        <el-dialog title="发起工单" :visible.sync="taskDialog" width="700px" custom-class="common-dialog" :append-to-body="true">
...
import {
    ...
    getChart,
    get_alarm_type_auto
} from '@/server/assets/assets_info_event.js'
...
import WorkInfo from '@/pages/alarm/seeTabs/WorkInfo'
...
.custom-star {
    .reset-btn {
        ...
        box-shadow: 0 0 10px inset #00a7ff;
    }
}
.save-btn {
    margin-right: 10px;
...
.event-content ::v-deep .time-panel-picker {
    top: 440px !important;
}
