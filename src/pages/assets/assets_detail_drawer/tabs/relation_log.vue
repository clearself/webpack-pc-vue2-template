            ...
            <el-table-column type="expand" class-name="expand-col" width="40">
                <template slot-scope="{row}">
                    <el-tabs style="margin-left: 20px;">
                        <el-tab-pane label="键/值" class="demo-table-left">
                        ...
                        <el-tab-pane v-if="row.nftData === 2" label="PCAP包" style="overflow: hidden;padding: 0 20px;max-width: 1000px;">
                            <div class="table-expand pcap-detail" style="overflow-y: auto;max-width: 800px;max-height: 500px;font-size: 12px;text-align: justify;word-break: break-all;">
                                <div style="margin-bottom: 10px;">
                                    ...
                                    <a :href="'/api/assets-manage/manage/syslogAssets/downloadPacap?logId='+row.id" download>
...
export default {
    ...
    methods: {
        ...
        setData(val) {
            ...
            //     console.log(val.some(i => item.fieldId == i))
            //     return val.some(i => item.fieldId == i)
            // })
            // console.log(arr3, 'knkan')
            // return arr3
        },
        getStashFields() {
            let data = {
            ...
            getField(data).then(async res => {
                console.log('缓存字段', res)
                this.list = this.setData(res)
                console.log('list字段', this.list, this.listAll1)
        ...
        get_data() {
            console.log(this.list, this.listAll)
            // let list1 = []
            // if (this.listALL.length > 0 && this.list.length == 0) {
            //     list1 = this.listALL
            // } else {
            ...
            let data = {
                ...
                paramsData: {
                    inputTerm: this.customTime.length > 0 ? [{ field: 'startTime', value: this.customTime[0] }, { field: 'endTime', value: this.customTime[1] }, ...ipsVal] : [],
