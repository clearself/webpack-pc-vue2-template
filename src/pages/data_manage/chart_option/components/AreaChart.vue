<template>
    <div style="width:100%;height:100%" ref="areaRef"><div style="width:100%;height: 100%;" ref="myEcharts" class="echarts"></div></div>
</template>
...
export default {
    name: 'LineChart',
    props: ['allFieldList', 'chartData', 'chatAreaOption', 'seq', 'type'],
    data() {
        return {
            myChart: null,
            loading: true,
    ...
    methods: {
        ...
        renderChart() {
            ...
            console.log(series)
            console.log(colors)
            console.log(this.$refs.areaRef.clientWidth)
            const legendSort = []
            const legendColor = []
            series.forEach(item => {
            ...
            let clientWidth = this.$refs.areaRef.clientWidth
            let fontSize = 12
