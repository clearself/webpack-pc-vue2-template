                ...
                <div class="content-right-one">
                    ...
                    <div>
                        <el-table ref="multipleTable" v-loading="loading" class='bigTable' :data="tableData" border stripe tooltip-effect="dark" :height="310">
                            ...
                            <el-table-column prop="name" width="110" label="名称" show-overflow-tooltip>
                            </el-table-column>
                            ...
                            <el-table-column label="查询条件">
                                <template slot-scope="scope">
                                    <div class="ub">
                                        <div style="width: 90px;color:#0052d9">检索时间：</div> <div style="width: 110px;word-break:break-all;word-wrap: break-word;overflow:auto"> {{unitTime(scope.row.time,scope.row.timeStatus)}}{{scope.row.timeStatus?unitText(scope.row.timeStatus):''}}</div>
                                    </div>
                                    <div class="ub">
                                        <div style="width: 90px;color:#0052d9">搜索条件：</div> <div style="width: 110px;word-break:break-all;word-wrap: break-word;overflow:auto"> {{ scope.row.sqlStr }}</div>
                                    </div>
                                    <div class="ub">
                                        <div style="width: 90px;color:#0052d9">过滤条件：</div> <div style="width: 110px;word-break:break-all;word-wrap: break-word;overflow:auto"> {{ scope.row.groupStr }}</div>
                                    </div>
                                </template>
                            </el-table-column>
...
import { pageDashboardChart, deleteDashboardChart } from '@/server/alarm_log/chart_record.js'
export default {
    props: ['chartDialog'],
    components: {
        Classify
