<template>
    <div class="event event-wrapper attack_type">
        <SearchTop @search="search" @reset="reset">
            <el-col :md="12" :lg="8" :xl="6">
                <el-form :model="searchForm">
                    <el-form-item label="子类编码:" label-width="80px">
            ...
            <el-col :md="12" :lg="8" :xl="6">
                <el-form  :model="searchForm">
                    <el-form-item label="子类名称:" label-width="80px">
        ...
        <div class="list-container">
            <el-table
                ...
                <el-table-column prop="code" label="安全风险子类编码" width="200" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="name" label="安全风险子类名称" width="200" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="bigName" label="安全风险大类名称" width="200" show-overflow-tooltip>
                </el-table-column>
            ...
            <pagination v-if="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="get_data" />
        </div>
        <el-dialog title="编辑" width="960px" :visible.sync="addEditDialog" custom-class="attendance-dialog">
            <el-form ref="formData" :model="formData" :rules="rules">
                <el-form-item label="安全风险大类名称：" :label-width="formLabelWidth">
                    <el-input disabled size="small" clearable v-model.trim="formData.bigName"></el-input>
                </el-form-item>
                <el-form-item label="安全风险子类名称：" :label-width="formLabelWidth">
