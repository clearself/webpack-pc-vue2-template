            ...
            report_navs: [
                {
                    ...
                    id: 1,
                    isActive: true,
                    pathName: 'externalNetwork_fail'
                },
                {
                    name: '内部网络攻击',
                    id: 2,
                    isActive: true,
                    pathName: 'internalNetwork_fail'
                },
                {
                    name: '证联网接入区安全告警',
                    id: 3,
                    isActive: true,
                    pathName: 'certificateNetwork_fail'
                },
                {
                    name: '异常外连',
                    id: 4,
                    isActive: true,
                    pathName: 'abnormalOutreach_fail'
                },
                {
                    name: 'DDOS攻击',
                    id: 5,
                ...
                },
                {
                    ...
                    id: 6,
                    isActive: false,
                    pathName: 'maliciousCode_fail'
                },
                {
                    name: '恶意邮件',
                    id: 7,
                    isActive: false,
                    pathName: 'maliciousMail_fail'
                },
                {
                    name: '仿冒/钓鱼网站',
                    id: 8,
                    isActive: false,
                    pathName: 'phishingWebsite_fail'
                },
                {
                    name: '仿冒APP',
                    id: 9,
                    isActive: false,
                    pathName: 'fakeApp_fail'
                }, {
                    name: '网站篡改',
                    id: 10,
                    isActive: false,
                    pathName: 'websiteTampering_fail'
                }, {
                    name: '上报统计校验',
                    id: 11,
                    isActive: false,
                    pathName: 'reportStatistics_fail'
                }
            ]
        }
    },
