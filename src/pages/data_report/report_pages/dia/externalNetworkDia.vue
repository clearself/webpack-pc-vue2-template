...
import { externalNetworkSaveReq } from '@/server/reporting_platform/report_pages'
            ...
            this.$refs.ruleForm.validate(async valid => {
                if (valid) {
                    ...
                    if (!this.row) {
                        ...
                        try {
                            await externalNetworkSaveReq(data)
