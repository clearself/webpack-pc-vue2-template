        ...
        <div class="ub w100" style="box-sizing: border-box;">
            <div class="event-content w100" :style="{'height':tabHeight+'px'}" style="overflow-y:auto">
                <div class="ub ub-pj w100 ub-ac" style="padding:10px">
                    <div style="color:rgba(0,0,0,0.9);font-size:14px">添加防守成果
                    </div>
                    <div>
                    ...
                    <div class="base-box">
                        <div  class="ub ub-pj">
                            <el-form-item label="选择演练：" size="small" prop="match" style="width: calc((100% - 168px) / 3);">
                                <el-select style="width: 100%;" clearable filterable v-model.trim="form.match" placeholder="请选择">
                                    <el-option v-for="item in matchs" :key="item.value" :label="item.label" :value="item.value">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item label="防御时间：" prop="matchTime" size="small" style="width: calc((100% - 168px) / 3);">
                                <el-date-picker
                                    style="width:100%"
                                    clearable
                            ...
                            <el-form-item label="目标系统：" size="small" style="width: calc((100% - 168px) / 3);">
                                <el-input clearable placeholder="目标系统" style="width: 100%;" v-model.trim="form.target_system" autocomplete="off"></el-input>
                            </el-form-item>
                        </div>
                        <div class="ub ub-pj">
                            ...
                            <el-form-item label="攻击手段：" size="small" style="width: calc((100% - 168px) / 3);">
                                <el-select style="width:100%" clearable filterable v-model.trim="form.attrack_way" placeholder="请选择">
                        ...
                        <div class="ub ub-pj">
                            ...
                            <el-form-item label="防御手段：" size="small" style="width: calc((100% - 168px) / 3);">
                                <el-select style="width: 100%;" clearable filterable v-model.trim="form.defense_way" placeholder="请选择">
                                    <el-option v-for="item in defense_ways" :key="item.value" :label="item.label" :value="item.value">
                                    </el-option>
                                </el-select>
                                <span v-if="form.defense_way==4" style="color:#fff;">--</span>
                                <el-input v-if="form.defense_way==4"  clearable placeholder="请输入其他防御手段" v-model.trim="form.other_defense_way" autocomplete="off"></el-input>
                            </el-form-item>
                            <div style="width: calc((100% - 168px) / 3);"></div>
                        </div>
                        <el-form-item style="width:100%;" label="防御步骤：">
                            <vue-ueditor-wrap v-model="form.step" :config="myConfig"></vue-ueditor-wrap>
                        </el-form-item>
                        <el-form-item style="width:100%;" label="防御成果：">
        ...
        publickRecord() {
            ...
            let data = {
                ...
                paramsData: {
                    ...
                    defenseMode: this.form.defense_way, // 攻击手段
                    defenseTime: this.form.matchTime,
            ...
            if (this.form.defense_way == 4) {
                data.paramsData.defenseModeContent = this.form.other_defense_way
            }
            console.log(data)
            add_attrack_defense_record(data).then((res) => {
                console.log('添加防御成果', res)
                this.$message({
                    message: '添加成功',
                    type: 'success'
                })
