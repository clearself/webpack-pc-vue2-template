                ...
                <el-form ref="form" :model="form" :rules="formRules" label-width="100px" label-position="top">
                    <div class="base-box">
                        ...
                        <div class="ub ub-pj">
                            ...
                            <el-form-item label="防御手段：" size="mini" style="width: calc((100% - 168px) / 3);">
                                ...
                                <el-input v-if="form.defense_way==4" style="width:100%;" clearable placeholder="请输入其他防御手段" v-model.trim="form.other_defense_way" autocomplete="off"></el-input>
                            </el-form-item>
...
export default {
    ...
    mounted() {
        this.$nextTick(() => {
            ...
            console.log('changeAttackForm', changeAttackForm)
            this.form = {
                ...
                defense_way: changeAttackForm.defense_way,
                other_defense_way: changeAttackForm.other_defense_way,
