    ...
    return {
        ...
        legend: { // =========小图标，圖表控件
            ...
            data: [{
                ...
                icon: 'image://static/img/jhj.png' // 如果用图片img，格式为'image://+icon文件地址'，其中image::后的//不能省略
            },
            {
                name: '服务器',
                icon: 'image://static/img/fwq.png'
            }, {
                name: '安全设备',
                icon: 'image://static/img/aqsb.png'
            }, {
                name: '终端',
                icon: 'image://static/img/zd.png'
            }
            ],
            textStyle: {
                color: '#9f9f9f'
        ...
        //因为力引导布局会在多次迭代后才会稳定，这个参数决定是否显示布局的迭代动画，在浏览器端节点数据较多（>100）的时候不建议关闭，布局过程会造成浏览器假死。
            ...
            // 数据
            data: data.data,
            links: data.links, // edges是其别名代表节点间的关系数据。
            categories: [ // symbol name：用于和 legend 对应以及格式化 tooltip 的内容。 label有效
                {
                    name: '交换机',
                    symbol: 'image://static/img/jhj.png',
                    label: { // 标签样式
                        color: 'red'
                    }
                }, {
                    name: '服务器',
                    symbol: 'image://static/img/fwq.png'
                }, {
                    name: '安全设备',
                    symbol: 'image://static/img/aqsb.png'
                }, {
                    name: '终端',
                    symbol: 'image://static/img/zd.png'
                }
            ]
        }]
    }
