    ...
    <div>
        ...
        <el-dialog title="提示" :visible.sync="finishDialog" width="700px" custom-class="common-dialog">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="finishDialog=false" size="small">取消</el-button>
                <el-button type="primary" @click="finishConfim" size="small">确认</el-button>
            </span>
        </el-dialog>
        <!-- 添加 -->
