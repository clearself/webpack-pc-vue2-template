...
<script>
import AutoRule from './custom_rule/index'
import Feature from './tar_feature_lib'
import Device from './tar_manage'
import Monitor from './tar_equipment_monitoring/index'

export default {
    name: 'Tar',
    mixins: [],
    components: { AutoRule, Feature, Device, Monitor },
    data() {
        return {
            types: [
                {
