            ...
            <div class="ub w100" style="box-sizing: border-box;">
                <div class="event-content w100">
                    <div class="ub ub-pj w100">
                        <div class="list-tips">编辑任务
                            <!-- <div style="display: inline-block;font-size:12px;color:#387dee;cursor: pointer;margin-left: 20px;" @click="back"><i
                        ...
                        <div>
                            ...
                            <el-button size="small" style="margin-right: 20px;" type="primary" @click="validAttrack('form')">提 交</el-button>
                        </div>
                    </div>
                                        ...
                                        <div class="select-box">
                                            <div style="cursor:pointer;" class="ub ub-ac select-title" @click.stop="onOff=!onOff">
                                                ...
                                                <div style="width:28px;height:28px;text-align: center;line-height: 28px;">
                                                    <i style="color:#ccc;" :class="{'el-icon-arrow-up':onOff,'el-icon-arrow-down':!onOff}"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="select-box">
                                            ...
                                            <div v-show="onOffAssign" class="select-mask assign" style="padding:10px 0;" @click.stop>
                                                <div class="assign-box w100" v-for="(item,index) in assignUsers" :key="index">
                                                    ...
                                                    <div v-for="(_item,_index) in item.children" :key="_index" class="ub assign-user w100" style="box-sizing: border-box;padding:0 10px 0 20px;background-color:rgba(0,0,0,.1);"  @click.stop="SingleSelectFun(_item,item)">
...
export default {
    ...
    mounted() {
        this.$nextTick(() => {
            ...
            this.form = {
                task_name: editInfo.taskName,
                outThing: editInfo.output,
                des: editInfo.des
            }
            ...
            this.currentNodeId = editInfo.groupId
            this.currentGroup = editInfo.groupName
            this.initTree()
                ...
                if (res.length > 0) {
                    res.forEach(item => {
                        if (item.users.length > 0) {
                            ...
                            if (!obj.children.some(_items => _items.checked === false)) {
                                obj.checked = true
                            } else {
                                obj.checked = false
                            }
    ...
    <style>
        ...
        .edui-default .edui-editor-toolbarboxouter {
            border-bottom: 1px solid #387dee!important;
             background-color: rgba(0,0,0,0)!important;
        }
    </style>
