...
export default {
    ...
    methods: {
        ...
        handleOther(data, index) {
            this.$setsessionStorage('temporary1', { actualTime: data.time, timeUnit: data.timeUnit + 1 })
        ...
        handleRelative(data, index) {
            this.$setsessionStorage('temporary1', { actualTime: '', timeUnit: '' })
        ...
        addTime() {
            ...
            saveLogTime(data).then(res => {
                ...
                this.$setsessionStorage('temporary1', { actualTime: this.actualTime, timeUnit: this.timeUnit + 1 })
                this.handleUse()
                this.$refs.datePopver.doClose()
                setTimeout(() => {
                    this.getLogTimeData()
