<template>
    <div class="custom-search" ref="selfRegion">
        <el-input
            ...
            <!-- <i v-if="type===2" @click="handleSave" slot="suffix" style="font-size: 12px;margin-right: 5px;cursor: pointer;" class="iconfont icon-baocun"></i> -->
        </el-input>
        ...
        <transition name="el-zoom-in-top">
            <div class="select-two" v-show="selectTwoShow">
                ...
                <div class="select-cell" @click="saveTask(2)">保存输出图表</div>
            </div>
        </transition>
    </div>
</template>
...
import { getGroupField, pageSearchHistory } from '@/server/stream_data_center/data_manage.js'
...
export default {
    ...
    methods: {
        ...
        searchIng(data) {
            console.log(this.searchSumList)
            this.searchHintList = []
