<template>
    <div>
        <el-drawer :visible.sync="alarmDialog" direction="rtl" :size="900" :show-close="true" :before-close="closeDialog" @close="closeDialog" :wrapperClosable="false">
                ...
                <div
                            ...
                            <div>
                                <i
                                    ...
                                    style="
                                        ...
                                        cursor: pointer;
                                    "
                                    @click="$parent.alarmDialog = false"></i>
                            </div>
                        </div>
                    </div>
                    <div class="drawer-pad">
                        <el-form :model="addForm" :rules="rules" ref="addForm" :inline="true">
                            <div class="ub ub-pj">
                                ...
                                <el-form-item label="事件类型:" :label-width="formLabelWidth" prop="reportType">
                                    <el-select size="small" v-model="addForm.reportType" clearable placeholder="请选择" style="width: 320px">
                                        <el-option v-for="(item,index) in typeList" :key="index" :label="item.name" :value="item">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                            </div>
                            ...
                            <el-form-item label="">
                                <div class="ub w100">
                                    <div style="width:70px;text-align:right;color:#fff;margin-right: 10px">
                                        事件描述:
                                    </div>
                        ...
                        <span slot="footer" class="dialog-footer">
                            <cancel-btn title="取 消"  @click="closeDialog" style="margin-right:10px"></cancel-btn>
                            <Debounce :time='10000' :isDebounce="2">
                                <searchBtn title="确 定" @click.native="handleQuery('addForm')" />
                            </Debounce>
                        </span>
                    </div>
                </div>
                    ...
                    if (this.selectMode === 1) {
                        data = {
                            ...
                            alarm: {
                                ...
                                reportType: this.addForm.reportType.id,
                                reportTypeName: this.addForm.reportType.name,
