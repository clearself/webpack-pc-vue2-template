...
export default {
    ...
    methods: {
        drawMap() {
            ...
            let chartData = this.$deepCopy(this.chartMes).reverse()
            ...
            chartData.forEach(item => {
                ...
                seriesData[0].data.push(item.allNum)
                seriesData[1].data.push(item.logNum)
                seriesData[2].data.push(item.reportNum)
            })
