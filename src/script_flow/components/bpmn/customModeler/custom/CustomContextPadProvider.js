...
import { batchCreateCustom, customShapeAction, customFlowAction, refeshCustomShapeAction } from '../utils/util'
...
ContextPadProvider.prototype.getContextPadEntries = function(element) {
    ...
    console.log(customShapeActions)
    // 只有点击列表中的元素才会产生的元素
    if (isAny(businessObject, ['bpmn:StartEvent', 'bpmn:Task', 'bpmn:BusinessRuleTask', 'bpmn:BoundaryEvent', 'bpmn:ExclusiveGateway', 'bpmn:ParallelGateway', 'bpmn:DataObjectReference', 'bpmn:IntermediateCatchEvent', 'bpmn:ServiceTask'])) {
