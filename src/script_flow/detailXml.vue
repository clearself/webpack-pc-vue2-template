        ...
        <el-container style="height: 100%">
            ...
            <el-container style="align-items: stretch">
                ...
                <el-aside class="panel-wrapper">
                    <panel v-if="modeler" :disabled="disabled" :processInstanceId="processInstanceId" :modeler="modeler" :users="users" :groups="groups" :categorys="categorys" />
                </el-aside>
            </el-container>
        </el-container>
    ...
    methods: {
        ...
        async createNewDiagram(data) {
            ...
            try {
                ...
                console.log(this.currentWorkIds)
        ...
        addOverLay(nodeId) {
            ...
            !this.workStatus && (this.nodeList = elementRegistry.filter(
                (item) => item.type === 'bpmn:UserTask' || item.type === 'bpmn:Task' || item.type === 'bpmn:ServiceTask' || item.type === 'bpmn:IntermediateCatchEvent'
            ))
            this.workStatus && (this.nodeList = elementRegistry.filter(
