...
// 漏洞概览
export const loopholeData = (data) => {
    return request({
        url: 'leaks/manage/overview/loopholeData',
        method: 'post',
...
export const getSortFieldleak = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getSortField',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 表格提交
export const getTableleaksChartSet = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getTableChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 柱状图提交
export const getBarleaksChartSet = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getBarChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 折线图提交
export const getLineleaksChartSet = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getLineChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 面积图提交
export const getArealeaksChartSet = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getAreaChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 饼图提交
export const getPieleaksChartSet = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getPieChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 指标提交
export const getTarleaksChartSet = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getTarChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 保存成图表
export const saveToleaksChart = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/saveToChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 获取组
export const findSearchTypeleaksChart = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/findSearchType',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 获取field对应的中文
export const getEnumInfoleaks = (data) => {
    return request({
        url: 'leaks/manage/leaksChartSet/getEnumInfo',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
