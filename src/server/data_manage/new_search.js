...
export const getSortField = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getSortField',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 表格提交
export const getTableChartSet = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getTableChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 柱状图提交
export const getBarChartSet = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getBarChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 折线图提交
export const getLineChartSet = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getLineChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 面积图提交
export const getAreaChartSet = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getAreaChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 饼图提交
export const getPieChartSet = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getPieChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 指标提交
export const getTarChartSet = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getTarChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 保存成图表
export const saveToChart = (data) => {
    return request({
        url: 'data-center/manage/chartSet/saveToChart',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 获取组
export const findSearchTypeCahrt = (data) => {
    return request({
        url: 'data-center/manage/chartSet/findSearchType',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
// 获取field对应的中文
export const getEnumInfo = (data) => {
    return request({
        url: 'data-center/manage/chartSet/getEnumInfo',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
export const getTreeOrg = (data) => {
    console.log(data)
    return request({
        url: 'data-center/manage/syslog/getOrgTree',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
...
export const getOrgLevel = (data) => {
    console.log(data)
    return request({
        url: 'data-center/manage/syslog/getOrgLevel',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    })
